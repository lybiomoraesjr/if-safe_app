...
export const MockUser: UserType = {
  ...
  email: "j.lybio@aluno.ifsp.br",
};

export const MockOccurrencesList: OccurrenceItemType[] = [
  {
    uuid: "occurrenceId1",
...
export const MockOccurrenceDetail: OccurrenceDetailType = {
  uuid: "occurrenceId1",
  title: "Fio desencapado",
  imageUri:
    "https://i0.wp.com/www.horalivre.com.br/wp-content/uploads/2021/02/phb-para-4.jpg?fit=600%2C450&ssl=1",
